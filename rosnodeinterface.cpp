...
// Generated 09-Feb-2021 22:04:52
  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
        ...
        ROS_INFO("** Starting the model \"vehicle_control\" **\n");
    ...
    boolean_T NodeInterface::getStopRequestedFlag(void)
    {
      ...
      return (!(rtmGetErrorStatus(vehicle_control_M)
                == (NULL)));

#else

      return (!(rtmGetErrorStatus(vehicle_control_M)
                == (NULL)) || rtmGetStopRequested(vehicle_control_M));
    ...
    {
      mRunModel = (rtmGetErrorStatus(vehicle_control_M) ==
                   (NULL));
      while (mRunModel) {
        mBaseRateSem.wait();
